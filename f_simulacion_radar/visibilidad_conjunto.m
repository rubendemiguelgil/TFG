function [mapa_conjunto,array_prf_ajustado,x_ref,y_ref] = visibilidad_conjunto(prf_array,n_para_deteccion,fi_apuntamiento_deg)
n_prf=size(prf_array,2);
array_prf_ajustado=[];
for i1=1:n_prf
   [mapa,prf_a,x,y]=f_visibilidad(prf_array(i1),fi_apuntamiento_deg); 
